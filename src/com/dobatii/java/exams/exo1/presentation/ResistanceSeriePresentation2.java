...
public class ResistanceSeriePresentation2 extends JFrame {
	...
	public ResistanceSeriePresentation2() {
		resistanceFormInit();
	...
	public void resistanceFormInit() {
		...
		setTitle("Partie 2 : Calcul la valeur de la résistance en fonction de la couleur de la LED. La source d’alimentation est soit 12V ou soit 5V");
		setVisible(true); 
	...
	//	System.out.println("resistanceService.calculerValeurResistanceEnfonctionDeCouleurLed() : " + resistanceService.calculerValeurResistanceEnfonctionDeCouleurLedEtTensionAlimentation(comboChoixCouleur.getSelectedItem().toString(), tAlimentation));
		
		return resistanceService.calculerValeurResistanceEnfonctionDeCouleurLedEtTensionAlimentation(couleur, tAlimentation);
	}
